...
from utils.core import fastdvdnet_batch_psnr
from utils.core import batch_ssim
from utils.losses import post_process_batch
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default='SINF')  # model in ['ForwardRNN', 'BiRNN', 'FloRNN', 'BasciVSRPlusPlus']
    parser.add_argument("--num_resblocks", type=int, default=5)
    parser.add_argument("--forward_count", type=int, default=3)
    parser.add_argument("--model_file", type=str,default='../logs/ckpt_e47.pth')
    parser.add_argument("--test_path", type=str,default='/data/vdn/Set8')
