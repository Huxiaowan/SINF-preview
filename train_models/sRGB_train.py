...
from utils.core import resume_training, save_model
from utils.core import fastdvdnet_batch_psnr, normalize_augment
from utils.core import log
from utils.losses import post_process, post_process_batch
from utils.losses import loss_function, loss_function_batch
...
if __name__ == '__main__':
    ...
    # Model parameters
    parser.add_argument("--model", type=str, default='SINF')
    parser.add_argument("--num_resblocks", type=int, default=10)
    ...
    parser.add_argument("--patch_size", "--p", type=int, default=144, help="Patch size")
    parser.add_argument("--patches_per_epoch", "--n", type=int, default=32000, help="Number of patches")

    # Paths
    parser.add_argument("--trainset_dir", default='data/vdn/Set8', type=str)
    parser.add_argument("--valset_dir", default='/data/vdn/Set8/', type=str)
